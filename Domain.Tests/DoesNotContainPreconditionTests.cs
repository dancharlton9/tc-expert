...
{
    public class DoesNotContainPreconditionTests : PreconditionTests<DoesNotContainPrecondition>, IDisposable
    {
        private Precondition _precondition;
        private List<Fact> _facts;
        private readonly PreconditionFactory _factory;

        public DoesNotContainPreconditionTests()
        {
            _factory = new PreconditionFactory();
            _precondition = _factory.GenerateNewPrecondition<DoesNotContainPrecondition>();
        ...
        {
            return _factory.GenerateNewPrecondition<DoesNotContainPrecondition>();
        }
